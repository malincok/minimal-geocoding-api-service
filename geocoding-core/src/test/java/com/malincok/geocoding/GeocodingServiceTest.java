...
public class GeocodingServiceTest {
    ...
    static GeocodingService service;

    @BeforeClass
    public static void load() {
        service = new GeocodingService("/test.osm");
    }

    @Test
    public void findByCoordinatesTest() {
        Poi result = service.findByCoordinates("lat=49.1922443&lon=16.6113382");
        Assert.assertNotNull(result);
        Assert.assertEquals("Brno", result.printName());
        ...
        //<node id="123456789" timestamp="2025-05-08T18:16:37Z" lat="49.1950266" lon="16.6147778">
            //<tag k="name" v="Malinovského náměstí"/>
        result = service.findByCoordinates("lat=49.1950266&lon=16.6147778");
        Assert.assertNotNull(result);
        Assert.assertEquals(123456789, result.getId());
        Assert.assertEquals("Malinovského náměstí", result.printName());
        ...
        //<node id="98989898" timestamp="2026-03-25T15:41:49Z" lat="49.1951704" lon="16.6096238">
            //<tag k="old_name" v="Schrattenbachův palác"/>
        result = service.findByCoordinates("lat=49.1951704&lon=16.6096238");
        Assert.assertNotNull(result);
        Assert.assertEquals("Knihovna Jiřího Mahena", result.printName());
        ...
        //<node id="99999999" timestamp="2026-05-31T15:11:50Z" lat="49.1976369" lon="16.6081832">
            ...
            //<tag k="name:es" v="Palacio del Gobernador"/>
            //<tag k="old_name" v="Augustiniánský klášter"/>
        result = service.findByCoordinates("lat=49.1976369&lon=16.6081832");
        Assert.assertNotNull(result);
        Assert.assertEquals(99999999, result.getId());
        Assert.assertEquals("Místodržitelský palác", result.printName());
    }

    @Test
    public void findByNameTest() {
        Poi result = service.findByName("Brno Główne");
        Assert.assertNotNull(result);
        Assert.assertEquals(3325029085L, result.getId());
        Assert.assertEquals("Brno hlavní nádraží", result.printName());

        result = service.findByName("Brno");
        Assert.assertNotNull(result);
        Assert.assertEquals(1601566699, result.getId());
        Assert.assertEquals("lat=49.1922443\nlon=16.6113382", result.printCoordinates());
        ...
        //<node id="123456789" timestamp="2025-05-08T18:16:37Z" lat="49.1950266" lon="16.6147778">
            //<tag k="name" v="Malinovského náměstí"/>
        result = service.findByName("Malinovského náměstí");
        Assert.assertNotNull(result);
        Assert.assertEquals(123456789, result.getId());
        ...
        //<node id="83365417" timestamp="2026-03-25T15:41:49Z" lat="49.1951704" lon="16.6096238">
            //<tag k="name" v="Knihovna Jiřího Mahena"/>
            //<tag k="old_name" v="Schrattenbachův palác"/>
        //<node id="1212121212"timestamp="2026-03-25T15:41:49Z" lat="49.1951704" lon="16.6096238">
            //<tag k="old_name" v="Schrattenbachův palác"/>
        result = service.findByName("Schrattenbachův palác");
        Assert.assertNotNull(result);
        Assert.assertEquals(83365417, result.getId());
        ...
        //<node id="21496199" timestamp="2026-08-15T05:47:00Z" lat="49.1906045" lon="16.6130691">
            //<tag k="name" v="Brno hl.n."/
        result = service.findByName("Brno hl.n.");
        Assert.assertNotNull(result);
        Assert.assertEquals(21496199, result.getId());
        ...
        //<node id="99999999" timestamp="2026-05-31T15:11:50Z" lat="49.1976369" lon="16.6081832">
            ...
            //<tag k="name:es" v="Palacio del Gobernador"/>
            //<tag k="old_name" v="Augustiniánský klášter"/>
        result = service.findByName("Palacio del Gobernador");
        Assert.assertNotNull(result);
        Assert.assertEquals(99999999, result.getId());
    }
}
